...
async function getCurrentWeatherAsnyc(location){
    ...
    return {
        temperature: isCelsius?data.temperature.degrees:data.temperature.degrees * 1.8 + 32,
